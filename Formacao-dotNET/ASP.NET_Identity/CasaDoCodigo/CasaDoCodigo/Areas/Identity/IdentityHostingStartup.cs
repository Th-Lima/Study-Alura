    ...
    internal class IdentityErrorDescriberPtBr : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError
            {
                ...
                Description = $"Este email {userName} já está sendo utilizado"
            };
        }
        ...
        public override IdentityError PasswordRequiresLower()
        {
            return new IdentityError
            {
                ...
                Description = "A senha precisa ter no mínimo uma letra miníscula ('a' - 'z')"
            };
        }
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric()
        {
            return new IdentityError
            {
                ...
                Description = "A senha deve ter pelo menos um caractere especial"
            };
        }
        ...
        public override IdentityError PasswordRequiresUpper()
        {
            return new IdentityError
            {
                ...
                Description = "A senha precisa ter no mínimo uma letra maiúscula ('A' - 'Z')"
            };
        }
